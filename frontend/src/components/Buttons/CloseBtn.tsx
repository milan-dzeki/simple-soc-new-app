...
import styles from '../../styles/components/buttons/closeBtn.module.scss';

interface Props {
  position: "btn__static" | "btn__absolute";
  size: "btn__big" | "btn__medium" | "btn__small";
  onClick: () => void;
}
...
const CloseBtn: FC<Props> = (props) => {
  return (
    <button
      type="button"
      className={`${styles.btn} ${styles[props.size]} ${styles[props.position]}`}
